...
public class PostDAO {
	...
	public ArrayList<PostDTO> getListPostByCategoryId(int categoryId) {
		ArrayList<PostDTO> lstPost = new ArrayList<PostDTO>();
		Connection con = null;
		Statement stmt = null;
		logger.info("Logging begins...");
		try {
			...
			String query = "SELECT * FROM eb_posts WHERE  categoryId ='" + categoryId + "' AND del_flg = 0 and postStatus = 1";
			stmt = (Statement) con.createStatement();
