...
public class PostDTO {
	 ...
	 * @param deleteDate
	 */
	public PostDTO(int postId, int commentId, int userId, int chapterId, String postName, String contents,
			String description, String authorName, String image, double price, int saleoff, String linkDownload,
			boolean postType, boolean del_flg, Date createDate, Date updateDate, Date deleteDate) {
		super();
		this.postId = postId;
