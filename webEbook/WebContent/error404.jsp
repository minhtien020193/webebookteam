...
<title>Chức năng này chưa được cập nhật</title>
</head>
<body class="ebook-product">
			...
			<div class="row">
				<div class="col-md-12">
					<ol class="breadcrumb">
						...
						<li>Chức năng này chưa được cập nhật</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<div class="wrap">
		<div class="hidden">404</div>
		<div class="container" style="min-height: 400px;">
			<div class="noEbook">
				Chức năng này chưa được cập nhật.<br /> <a href="home">Hãy quay
					về trang chủ</a>
			</div>
