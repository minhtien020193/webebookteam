				...
				<div class="container" id="addChapter">
					<div class="product-content-box">
						...
						<div class="row box-product-lifestyle">
							<h3 class="product-table-title">Chỉnh sửa nội dung chương:</h3>
						</div>
						<div class="col-sm-12">
							<div class="row box-product-lifestyle">
								<form action="updateChapter" method="post">
									<div class="row">
										<input type="hidden" name="postId"
											...
											type="hidden" name="chapterId"
											value="<s:property value="chapterDTO.chapterId" />" />
										<div class="col-sm-2">Tên chương:</div>
										<div class="col-sm-10">
											<input type="text" name="chapterName"
												value="<s:property value="chapterDTO.chapterName" />" />
										</div>
									</div>
									<div class="row">
