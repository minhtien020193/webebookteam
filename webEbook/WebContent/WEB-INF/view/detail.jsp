...
<body class="ebook-product">
	...
	<s:if test="!postExist">
		<div class="wrap">
			<div class="container" style="min-height: 100%;">
				<div class="noEbook">
					Bài viết không được tìm thấy.<br /> <a href="home">Hãy quay về
						trang chủ</a>
				</div>
			</div>
		</div>
	...
	<s:else>
				...
				<div class="col-md-7">
					<div class="item-box">
						<h1 class="item-name" itemprop="name">
							...
							<s:if test="!postDTO.postStatus"><span class="hold-post">(đang chờ duyệt)</span></s:if>
						</h1>
		...
		<input type="hidden" id="pageValue" value="<s:property value="page" />"/> 
			<div class="container box-comment margin-comment20">
									...
									<div class="item">
										...
										<div class="col-md-10">
											...
											<s:if test="noFeedback">
												<div class="link">
													<span class="text-success"></span> <span>Nhận xét
														này hữu ích với bạn?</span>
							...
							<ul class="pagination">
								<s:iterator begin="1" end="countPage" status="stat">
									<li class="page-item"><a
										...
										href="?postId=<s:property value="postDTO.postId"/>&page=<s:property value="#stat.count" />">
